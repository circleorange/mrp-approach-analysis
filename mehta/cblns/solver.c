...
int main(int argc, char *argv[]) {
	...
	if (modelfilename != NULL && iassignmentfilename != NULL) {
		...
		/* Initialize tracking for process reassignments */
		sprintf(trackingFilename, "%s_tracking.csv", solutionfilename ? solutionfilename : "mehta_solution");
		simple_init_tracking(trackingFilename);
